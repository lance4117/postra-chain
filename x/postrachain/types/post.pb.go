...
// source: postrachain/postrachain/v1/post.proto
...
func (*Post) Descriptor() ([]byte, []int) {
	return fileDescriptor_97b0f20392ef764f, []int{0}
}
...
func (m *Post) GetContentUri() string {
	if m != nil {
		return m.ContentUri
	}
	return ""
...
func (m *Post) GetContentHash() string {
	if m != nil {
...
func init() {
	proto.RegisterType((*Post)(nil), "postrachain.postrachain.v1.Post")
}

func init() {
	proto.RegisterFile("postrachain/postrachain/v1/post.proto", fileDescriptor_97b0f20392ef764f)
}

var fileDescriptor_97b0f20392ef764f = []byte{
	// 234 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Post) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ContentHash) > 0 {
		...
		i = encodeVarintPost(dAtA, i, uint64(len(m.ContentHash)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.ContentUri) > 0 {
		...
		i = encodeVarintPost(dAtA, i, uint64(len(m.ContentUri)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Title) > 0 {
